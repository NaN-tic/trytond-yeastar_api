#!/usr/bin/env python
# This file is part yeastar_api module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-yeastar_api',
    download_url='https://github.com:nantic/trytond-yeastar_api.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-yeastar_api.git'
    },
    classifiers=[
